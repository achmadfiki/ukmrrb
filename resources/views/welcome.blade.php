...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<head>
      ...
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css">
		...
		<link rel="shortcut icon" href="{{asset('assets/icons/logoukm.ico')}}">
         ...
         <nav class="nav container">
            <div class="nav__data">
				<a class="navbar-brand" href="#">
					<img src="{{asset('assets/images/logounej.png')}}" hight="50" width="50" alt=""href="#">
					<img src="{{asset('assets/images/logorobotika.png')}}" hight="50" width="50" alt=""href="#">
				</a>
               
            <div class="nav__toggle" id="nav-toggle">
				  <img src="{{ asset('assets/icons/menu-line.png') }}" alt="Menu" class="nav__burger">
				  <img src="{{ asset('assets/icons/close-fill.png') }}" alt="Menu" class="nav__close">
               </div>
            </div>
            ...
            <div class="nav__menu" id="nav-menu">  
               <ul class="nav__list">
                  ...
                  <li class="dropdown__item">
                     <div class="nav__link">
                        Analytics <img src="{{ asset('assets/icons/arrow-down-s-line.png') }}" alt="" class="dropdown__arrow">
                     </div>
                  ...
                  <li class="dropdown__item">
                     <div class="nav__link">
                        Users  <img src="{{ asset('assets/icons/arrow-down-s-line.png') }}" alt="" class="dropdown__arrow">
                     </div>
         ...
         <div class="container1">
            <div class="row1">
                  <div class="col1" id="company">
                      <img src="{{asset('assets/images/logorobotika.png')}}" alt="" class="logo">
                      <p>
